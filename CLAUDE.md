...
> **DO NOT create new rule files alongside this file.**
...
1. **All rules belong in `axiarch-rules/`.** Do not create rule files alongside this file.
...
3. **DO NOT alter the pointer structure of this `CLAUDE.md`.**
